...
BIOS files *not* provided here, due to uncertainty regarding the copyright. It does require an _non-interleaved_ VGA BIOS in order for it to work; most of the Cirrus BIOS files you find online are 'interleaved'. You can nonetheless find a suitable file, isamalaysia.bin (1.41), on the CL-GD5428 page of the VGA Legacy MkIII museum. 16-bit BIOS mode requires two PROM/EPROM/EEPROM/flash chips with identical BIOS contents.
